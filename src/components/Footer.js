        ...
        <div className="container-xxl">
          <div className="row">
            <div className="col-4">
              ...
              <div>
                <address className='text-white fs-6'>Hon: 277 Near Vill chopal, <br />
                  Sonipat, Haryana <br />PinCode: 131003</address>
        ...
        <div className="container-xxl">
          <div className="row">
            <div className="col-12">
              <p className='text-center mb-0 text-white'>&copy; {new Date().getFullYear()}; Powerd by Deleloper's Corner</p>
            </div>
          </div>
        </div>
      </footer>
