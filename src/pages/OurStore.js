                            ...
                            <div className='filter-card mb-3'>
                                ...
                                <div>
                                    <div className="product-tags d-flex flex-wrap align-item-center gap-10">
                                        <span className="badge bg-light text-secondary rouded-3 py-2 px-3">Headphone</span>
                                        <span className="badge bg-light text-secondary rouded-3 py-2 px-3">Laptop</span>
                                        <span className="badge bg-light text-secondary rouded-3 py-2 px-3">Mobile</span>
                                        <span className="badge bg-light text-secondary rouded-3 py-2 px-3">Wire</span>
                                    </div>
                                </div>
                            </div>
                            <div className='filter-card mb-3'>
